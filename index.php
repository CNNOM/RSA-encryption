...
<body>
    <div class="container">
        <div class="card">
            <h2><i class="fas fa-key"></i> Генерация ключей</h2>
        ...
        <div class="card">
            <h2><i class="fas fa-file-upload"></i> Работа с текстом</h2>
            ...
            <div id="manual-tab" class="tab-content active">
                <div class="form-group">
                    ...
                    <textarea id="message" rows="3" placeholder="Введите текст для шифрования...">Hello World!</textarea>
                </div>
            </div>
            ...
            <div id="file-tab" class="tab-content">
                <div class="form-group">
                    ...
                    <div id="fileInfo" class="file-info" style="display: none;">
                        <p><i class="fas fa-file"></i> Файл: <span id="fileName"></span> (<span id="fileSize"></span>
                            байт)</p>
        ...
        <div class="card">
            <h2><i class="fas fa-unlock"></i> Дешифрование</h2>
            <div class="form-group">
        ...
        <div class="card" style="display: none;">
            <h2><i class="fas fa-user-secret"></i> Атака факторизацией (только для обучения!)</h2>
            ...
            <div id="attackResult" class="attack-result" style="display: none;">
                ...
                <div id="crackedKey" style="display: none;">
                    <p><i class="fas fa-key"></i> <strong>Взломанный закрытый ключ d:</strong> <code
                            id="crackedD"></code></p>
                </div>
            </div>
        </div>
